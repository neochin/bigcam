...
create table IF NOT EXISTS qh_video(
 ...
 channel_id int(10),
 uuid VARCHAR(64),
 video_cover varchar(128),
 video_codec_name varchar(16),
 video_codec_type varchar(16),
 video_status varchar(32),
 video_msg varchar(256),
 display_aspect_ratio varchar(16),
 video_content varchar(128),
